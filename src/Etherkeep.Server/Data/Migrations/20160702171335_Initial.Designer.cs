...
namespace Etherkeep.Server.Data.Migrations
{
    ...
    [Migration("20160702171335_Initial")]
            ...
            modelBuilder.Entity("Etherkeep.Server.Data.Entities.UserPrimaryEmailAddress", b =>
                {
                    ...
                    b.HasAlternateKey("PrimaryEmailAddress");

                    b.HasIndex("PrimaryEmailAddress")
                        .IsUnique();
            ...
            modelBuilder.Entity("Etherkeep.Server.Data.Entities.UserPrimaryEmailAddress", b =>
                {
                    b.HasOne("Etherkeep.Server.Data.Entities.EmailAddress", "EmailAddress")
                        ...
                        .HasForeignKey("Etherkeep.Server.Data.Entities.UserPrimaryEmailAddress", "PrimaryEmailAddress")
                        .OnDelete(DeleteBehavior.Cascade);
