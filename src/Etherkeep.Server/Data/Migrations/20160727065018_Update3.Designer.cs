...
namespace Etherkeep.Server.Data.Migrations
{
    ...
    [Migration("20160727065018_Update3")]
    partial class Update3
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Etherkeep.Server.Data.Entities.ExternalPaymentSuspenseWallet", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Etherkeep.Server.Data.Entities.PaymentSuspenseWallet", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Etherkeep.Server.Data.Entities.ExternalPaymentSuspenseWallet", b =>
                {
                    b.HasOne("Etherkeep.Server.Data.Entities.ExternalPayment", "ExternalPayment")
                        .WithOne("SuspenseWallet")
                        .HasForeignKey("Etherkeep.Server.Data.Entities.ExternalPaymentSuspenseWallet", "ExternalPaymentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Etherkeep.Server.Data.Entities.PaymentSuspenseWallet", b =>
                {
                    b.HasOne("Etherkeep.Server.Data.Entities.Payment", "Payment")
                        .WithOne("SuspenseWallet")
                        .HasForeignKey("Etherkeep.Server.Data.Entities.PaymentSuspenseWallet", "PaymentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
