...
namespace Etherkeep.Data
{
    public class ApplicationDbContext : OpenIddictDbContext<User, IdentityRole<Guid>, Guid>
    {
        ...
        public DbSet<MerchantWalletAddress> MerchantWalletAddresses { get; set; }
        ...
        public virtual DbSet<UserWalletAddress> UserWalletAddresses { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Currency>(entity =>
            {
                ...
                entity.HasMany(e => e.MerchantBills).WithOne(e => e.Currency).HasForeignKey(e => e.CurrencyCode);
            ...
            builder.Entity<MerchantBill>(entity =>
            {
                entity.HasKey(e => e.Id);
                entity.HasOne(e => e.Merchant).WithMany(e => e.Bills).HasForeignKey(e => e.MerchantId);
                entity.HasOne(e => e.Currency).WithMany(e => e.MerchantBills).HasForeignKey(e => e.CurrencyCode);
                entity.HasMany(e => e.Payments).WithOne(e => e.MerchantBill).HasForeignKey(e => e.MerchantBillId);
                entity.HasOne(e => e.WalletAddress).WithOne(e => e.MerchantBill).HasPrincipalKey<MerchantWalletAddress>(e => e.Address);
            });

            builder.Entity<Merchant>(entity =>
            {
                entity.HasKey(e => e.Id);
                entity.HasOne(e => e.User).WithMany(e => e.Merchants).HasForeignKey(e => e.UserId);
                entity.HasMany(e => e.Bills).WithOne(e => e.Merchant).HasForeignKey(e => e.MerchantId);
            });

            builder.Entity<MerchantWallet>(entity =>
            {
                entity.HasKey(e => e.Id);

                entity.HasOne(e => e.Merchant).WithMany(e => e.Wallets).HasForeignKey(e => e.MerchantId);
                entity.HasMany(e => e.WalletAddresses).WithOne(e => e.Wallet).HasForeignKey(e => e.WalletId);
            });

            builder.Entity<MerchantWalletAddress>(entity =>
            {
                entity.HasKey(e => e.Address);
                entity.HasOne(e => e.Wallet).WithMany(e => e.WalletAddresses).HasForeignKey(e => e.WalletId);
                entity.HasOne(e => e.MerchantBill).WithOne(e => e.WalletAddress).HasPrincipalKey<MerchantWalletAddress>(e => e.Address);
            });
            ...
            builder.Entity<Payment>(entity =>
            {
                ...
                entity.HasOne(e => e.MerchantBill).WithMany(e => e.Payments).HasForeignKey(e => e.MerchantBillId).IsRequired(false);
